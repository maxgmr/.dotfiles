...
-- Shut down hyprland
hl.bind(mainMod .. " + SHIFT + " .. codeE, hl.dsp.exec_cmd("uwsm stop"))
...
-- App launchers
hl.bind(mainMod .. " + " .. codeEnter, hl.dsp.exec_cmd("app2unit -- " .. options.terminal))
hl.bind(mainMod .. " + " .. codeD, hl.dsp.exec_cmd("app2unit -- " .. options.menu))
hl.bind(mainMod .. " + " .. codeE, hl.dsp.exec_cmd("app2unit -- " .. options.fileManager))
hl.bind(mainMod .. " + " .. codeT, hl.dsp.exec_cmd("app2unit -- " .. options.browser))
...
hl.bind(mainMod .. " + SHIFT + " .. codeS, hl.dsp.exec_cmd("app2unit -- sh -c 'grim -g \"$(slurp)\" - | swappy -f -'"))
