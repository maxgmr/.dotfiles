...
M.setup = function()
    local vim_sev = vim.diagnostic.severity
    ...
    local config = {
        ...
        signs = {
            text = {
                [vim_sev.ERROR] = globals.error_symbol,
                [vim_sev.WARN] = globals.warning_symbol,
                [vim_sev.HINT] = globals.hint_symbol,
                [vim_sev.INFO] = globals.info_symbol,
            }
        },
